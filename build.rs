...
fn configure_lib_bagl(command: &mut cc::Build, bolos_sdk: &String) {
    if env::var_os("CARGO_FEATURE_LIB_BAGL").is_some() {
        command
            ...
            .define("HAVE_BAGL_GLYPH_ARRAY", None)
            .define("HAVE_BAGL_GLYPH_ICON_CHECK", None)
            .define("HAVE_BAGL_GLYPH_ICON_CROSS", None)
            .define("HAVE_BAGL_GLYPH_ICON_CHECK_BADGE", None)
            .define("HAVE_BAGL_GLYPH_ICON_LEFT", None)
            .define("HAVE_BAGL_GLYPH_ICON_RIGHT", None)
            .define("HAVE_BAGL_GLYPH_ICON_UP", None)
            .define("HAVE_BAGL_GLYPH_ICON_DOWN", None)
